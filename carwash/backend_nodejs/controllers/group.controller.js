    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Group.findAll({ where: condition })];
            case 1:
                chk = _a.sent();
                if (chk.length > 0) {
                    res.status(401).send({
                ...
                return [4 /*yield*/, Group.create(group)
                        .then(function (data) {
                        res.send(data);
                    })["catch"](function (err) {
                        res.status(500).send({
...
exports.findOne = function (req, res) {
    ...
    Group.findByPk(id)
        ...
        if (data) {
            ...
            res.status(404).send({
                message: "Cannot find Group with id=".concat(id, ".")
            });
        }
    })["catch"](function (err) {
        res.status(500).send({
...
exports.update = function (req, res) {
    ...
    Group.update(req.body, {
        ...
        if (num == 1) {
            ...
            res.send({
                message: "Cannot update Group with id=".concat(id, ". Maybe Group was not found or req.body is empty!")
            });
        }
    })["catch"](function (err) {
        res.status(500).send({
...
exports["delete"] = function (req, res) {
    ...
    Group.destroy({
        ...
        if (num == 1) {
            ...
            res.send({
                message: "Cannot delete Group with id=".concat(id, ". Maybe Group was not found!")
            });
        }
    })["catch"](function (err) {
        res.status(500).send({
...
exports.deleteAll = function (req, res) {
    Group.destroy({
        ...
        .then(function (nums) {
        res.send({ message: "".concat(nums, " Groups were deleted successfully!") });
    })["catch"](function (err) {
        res.status(500).send({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Group.create(washType)];
            case 2:
                result = _a.sent();
                if (result === null) {
...
exports.findByName = function (name) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Group.findAll({ where: { name: name } })];
            case 1:
                result = _a.sent();
                return [2 /*return*/, result];
        }
